...
explainer3 <- tm_explainer(fitted_model1 , dataset = data_test[-14], target_var = as.factor(data_test$condition), label = 'randomForest3' )
...
plot(overall_comparison(explainer1, explainer3, type = 'classification'))
